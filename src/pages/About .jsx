...
function About () {
  return (
   ...
   <div className="container my-4">
    <h1>About</h1>
<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint distinctio quidem iste laudantium modi reprehenderit, voluptatum beatae iure voluptatibus, eum quaerat laboriosam repellat minus nesciunt veniam fugit ratione eligendi facere dolorum eos reiciendis in obcaecati molestiae suscipit. Aspernatur, repellat aliquam!</p>
